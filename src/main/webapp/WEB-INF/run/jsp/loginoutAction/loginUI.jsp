...
<body leftmargin=0 topmargin=0 marginwidth=0 marginheight=0
	...
	/* 防止页面嵌套，也就是防止在新窗口打开后，在新窗口注销后，对老窗口的影响 */
				...
				<div id="LoginInfo">
					<table border=0 cellspacing=0 cellpadding=0 width=100%>
						...
						<tr>
							...
							<td>
								<%-- 用户名 --%> <s:textfield size="20" cssClass="TextField"
									name="loginName" />
							</td>
						...
						<tr>
							...
							<td>
								<%-- 密码，不需要回显 --%> <s:password size="20" cssClass="TextField"
									showPassword="false" name="password" />
							</td>
						</tr>
					</table>
				</div>
